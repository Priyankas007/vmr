...
from vmr_data import create_data_loader
...
if __name__ == "__main__":
    ...
    parser.add_argument('--run_folder', type=str, required=True, help='Path to the folder where best_model.pth is saved')
    ...
    parser.add_argument('--model_type', type=str, default='GSViT', help='Model type (for clarity)')
